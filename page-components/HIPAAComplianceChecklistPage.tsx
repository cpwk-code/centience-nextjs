...
import { z } from "zod";
import { Shield, CheckCircle, AlertTriangle, XCircle, ArrowRight, ArrowLeft, FileCheck } from "lucide-react";
...
import { questions, sections, MAX_SCORE, getReadinessLevel } from "@/data/hipaaComplianceQuestions";
...
const HIPAAComplianceChecklistPage = () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke("submit-risk-assessment", {
        body: {
          ...
          assessmentType: "hipaa-compliance-checklist",
          // Security fields
          website: honeypot,
          formStartTime,
    ...
    switch (level) {
      case "excellent":
        return {
          ...
          title: "Excellent HIPAA Compliance",
          description: "Your organization demonstrates strong HIPAA security compliance. Continue maintaining your safeguards and stay updated on regulatory changes.",
        };
      case "good":
        return {
          icon: Shield,
          ...
          description: "You have a solid foundation for HIPAA compliance. Address the identified gaps to strengthen your ePHI protection.",
        };
      case "moderate":
        return {
          icon: AlertTriangle,
          ...
          title: "Moderate Compliance Level",
          description: "There are significant gaps in your HIPAA compliance. Prioritize improvements in key safeguard areas to reduce risk.",
        };
      case "needs-improvement":
        return {
          ...
          description: "Critical HIPAA compliance gaps exist. Immediate action is required to protect ePHI and avoid potential penalties.",
        };
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="HIPAA Compliance Checklist | ePHI Security Assessment | Compuwork"
        description="Evaluate your HIPAA and ePHI compliance with our comprehensive security checklist. Aligned with the HIPAA Security Rule, HHS/OCR guidance, and NIST standards."
        canonical="/hipaa-compliance-checklist"
        keywords={[
        ...
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'HIPAA Compliance Checklist', url: '/hipaa-compliance-checklist' },
        ]}
      />
      <Header />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 rounded-full border border-emerald-500/20 mb-6">
              ...
              <span className="text-sm font-medium text-emerald-400">HIPAA Compliance Checklist</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Download this comprehensive checklist to evaluate your ePHI protection against the HIPAA Security Rule (45 CFR Part 164) and HHS/OCR guidance.
            </p>
          </AnimatedSection>
        </div>
      </section>
              ...
              <AnimatedSection>
                <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
                  ...
                  <p className="text-muted-foreground mb-8">
                    Please provide your details so we can send you a detailed HIPAA compliance report and recommendations.
                  </p>
                  ...
                  <form onSubmit={handleSubmit(onContactSubmit)} className="space-y-6">
                    ...
                    <Button type="submit" size="lg" className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white">
                      Start Assessment
                  ...
                  >
                    ...
                    >
                      {currentQuestion.options.map((option, index) => (
                        <div
                          key={index}
                          className={`flex items-center space-x-3 p-4 rounded-lg border transition-all cursor-pointer hover:border-emerald-500/50 ${
              ...
              <AnimatedSection>
                <div className="space-y-8">
                  ...
                  <div className="bg-card border border-border rounded-2xl p-8 shadow-xl text-center">
                    <h2 className="text-2xl font-bold mb-4">Your HIPAA Compliance Score</h2>
                  ...
                  {/* CTA */}
                  <div className="bg-gradient-to-r from-emerald-500/10 to-emerald-400/10 border border-emerald-500/20 rounded-2xl p-8 text-center">
                    <h3 className="text-2xl font-bold mb-4">Ready to Strengthen Your HIPAA Compliance?</h3>
                    <p className="text-muted-foreground mb-6">
                      Our healthcare IT experts will review your assessment and provide personalized recommendations for improving your ePHI protection.
                      {contactData && ` We'll contact you at ${contactData.email} within 24 hours.`}
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white" asChild>
...
export default HIPAAComplianceChecklistPage;
