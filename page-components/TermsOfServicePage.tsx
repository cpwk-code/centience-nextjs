...
const TermsOfServicePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Terms of Service | CompuWork"
        description="Read CompuWork's Terms of Service. These terms govern your use of our website and services, including intellectual property rights, limitations of liability, and user responsibilities."
        canonical="https://compuwork.ai/terms-of-service"
      />
      <Header />
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
                ...
                <div className="bg-card border border-border rounded-xl p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and CompuWork Inc. ("we," "us" or "our"), concerning your access to and use of the compuwork.ai website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the "Site").
                  </p>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-xl p-8">
                  ...
                  <div className="space-y-2 text-muted-foreground">
                    <p><strong>CompuWork Inc.</strong></p>
                    <p><strong>Email:</strong>{" "}
                      <a href="mailto:info@compuwork.ai" className="text-primary hover:underline">
                        info@compuwork.ai
                      </a>
                    </p>
                    <p><strong>Phone:</strong>{" "}
                      <a href="tel:+18779457177" className="text-primary hover:underline">
                        (877) 945-7177
                      </a>
                    </p>
