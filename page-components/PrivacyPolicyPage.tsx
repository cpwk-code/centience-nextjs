...
const PrivacyPolicyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Privacy Policy | CompuWork"
        description="Learn how CompuWork collects, uses, and protects your personal information. Our privacy policy outlines our commitment to data security and your privacy rights."
        canonical="https://compuwork.ai/privacy-policy"
      />
      <Header />
            ...
            <AnimatedSection direction="up">
              <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
                ...
                <div className="bg-card border border-border rounded-xl p-8">
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                    <li>We will not be responsible for the privacy of data collected by websites not owned or managed by CompuWork, including those linked through our website</li>
