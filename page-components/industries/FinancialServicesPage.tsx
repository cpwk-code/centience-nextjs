      ...
      <div className="container mx-auto">
        <div className="max-w-4xl">
          <div className="border border-accent/20 rounded-xl p-5 bg-accent/5 mb-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-3">FINRA Rule 4511 and SEC Rule 17a-4 require a 6-year retention baseline — but retention only works when data is classified. Financial services firms need data classification policies that identify client asset records, AI-generated outputs, and off-channel communications (WhatsApp, text) before those records can be governed. Access control governance over who can see client financial data is equally foundational to SEC examination readiness.</p>
