...
import miamiImage from "@/assets/locations/managed-it-services-miami.jpg";
...
const MiamiPage = () => {
  ...
  const whyChooseUs = [
    { title: "Local knowledge", description: "We understand Miami's business climate, regulatory environment, and common industry challenges" },
  ...
  const testimonials = [
    ...
    },
    {
      ...
      company: "Miami Healthcare Practice",
      rating: 5,
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes. Many Miami businesses use our co-managed model to extend their internal team. We handle monitoring, security, documentation, and complex issues while your in-house staff focuses on daily work.",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Managed IT Services in Miami"
        description="Compuwork provides audit-ready Managed IT Services in Miami. Specialized in cybersecurity and compliance for regulated businesses. Scale your Miami business with 24/7 expert support."
        canonical="/locations/managed-it-services-miami"
        keywords={[
          ...
          "SEC compliance IT Miami",
          "HIPAA IT services Miami",
          "Miami business IT solutions"
        ]}
        service={{
          serviceType: "Managed IT Services",
          provider: "Compuwork",
          areaServed: ["Miami", "Miami-Dade County", "Coral Gables", "Coconut Grove", "Doral", "Aventura", "Key Biscayne"],
        }}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "Florida", url: "/locations/managed-it-services-florida" },
          { name: "Miami", url: "/locations/managed-it-services-miami" },
        ]}
        faq={faqs}
      />

      <KeyFacts
        entityName="Compuwork Managed IT Services in Miami"
        entityType="LocalBusiness"
        description="Managed IT and cybersecurity services tailored for small and mid-sized regulated organizations across Miami. We support financial firms, law offices, healthcare practices, and growing businesses throughout Miami-Dade County."
        facts={[
          { label: "Service Area", value: "Miami - Brickell, Downtown, Coral Gables, Coconut Grove, Doral, Aventura, Key Biscayne" },
        ...
        contactInfo={{
          ...
          website: "https://compuwork.ai/locations/managed-it-services-miami",
        }}
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="pt-8">
              ...
              >
                ...
                <span className="text-primary-foreground/80 text-sm font-medium">Miami</span>
              </motion.div>
              ...
              >
                Compuwork delivers managed IT services & cybersecurity services in Miami designed to help companies achieve their goals.
              </motion.p>
          ...
          <div className="flex flex-col lg:hidden gap-8">
            <AnimatedSection>
              <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[3/4]">
                <img src={typeof miamiImage === "string" ? miamiImage : (miamiImage as any).src} 
                  alt="Miami Brickell financial district skyline for managed IT services in Miami."
            ...
            <AnimatedSection delay={0.2}>
              <h2 className="text-3xl font-bold font-display text-foreground mb-4">
                ...
                <span className="text-gradient-gold">Managed IT Services, Cybersecurity & Compliance</span>
              </h2>
              <h3 className="text-xl font-semibold text-foreground mb-4">
                Learn how Compuwork manages your IT in Miami
              </h3>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Compuwork provides customized managed IT and cybersecurity services, specifically for regulated organizations in Miami. Whether you have a financial advisory in Brickell, a law firm in Coral Gables, or a healthcare practice in Coconut Grove, we understand the business challenges in your area.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold font-display text-foreground mb-4">
              ...
              <span className="text-gradient-gold">Miami Businesses</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              As organizations across Miami grow and evolve, many face recurring IT and compliance challenges.
            </p>
          </AnimatedSection>
      ...
      <Services heading="Managed IT Services in Miami Built for" compactHeading />
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Miami's regulated industries rely on steady operations, strong security, and clear documentation. Compuwork delivers all three.
            </p>
          </AnimatedSection>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Trusted by regulated organizations across Miami
            </p>
          </AnimatedSection>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <AnimatedSection>
              <div className="rounded-2xl overflow-hidden border border-border shadow-lg">
                <iframe
                  title="Compuwork Service Coverage Area - Miami"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d114964.53925855961!2d-80.29949920266am!3d25.782390843992047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d9b0a20ec8c111%3A0xff96f271ddad4f65!2sMiami%2C%20FL!5e0!3m2!1sen!2sus!4v1706000000000!5m2!1sen!2sus"
                  width="100%"
                  height="400"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="mt-4 flex items-center gap-2 text-muted-foreground">
                ...
                <span className="text-sm">Serving Miami-Dade County and across South Florida</span>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                From Miami to New York, we provide on-site and remote IT support to businesses across the United States.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-primary-foreground/70 mb-8">
              If your Miami business needs dependable IT support, cybersecurity, and cloud solutions delivered by a partner who values relationships, compliance, and long-term results, Compuwork is ready.
            </p>
