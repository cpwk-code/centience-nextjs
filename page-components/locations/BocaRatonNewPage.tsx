...
import bocaRatonImage from "@/assets/locations/boca-raton-financial-district.jpg";
...
const BocaRatonNewPage = () => {
  ...
  const whyChooseUs = [
    { title: "Local knowledge", description: "We understand Boca Raton's business climate, regulatory environment, and common industry challenges" },
  ...
  const testimonials = [
    {
      ...
      company: "Boca Raton Financial Firm",
      rating: 5,
    },
    {
      ...
      company: "Boca Raton Healthcare Practice",
      rating: 5,
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes. Many Boca Raton businesses use our co-managed model to extend their internal team. We handle monitoring, security, documentation, and complex issues while your in-house staff focuses on daily work.",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Managed IT Services in Boca Raton | Compliance & Cybersecurity | Compuwork"
        description="Compuwork provides audit-ready Managed IT Services in Boca Raton. Specialized in cybersecurity and compliance for financial, legal, and healthcare firms. Scale your Boca Raton business with 24/7 expert support."
        canonical="/locations/managed-it-services-boca-raton"
        keywords={[
          "managed IT services Boca Raton",
          "managed IT services in Boca Raton",
          "IT management Boca Raton",
          "boca raton managed IT services",
          "managed it boca raton",
          "cybersecurity Boca Raton",
          "SEC compliance IT Boca Raton",
          "HIPAA IT services Boca Raton",
          "Boca Raton MSP",
          "IT support Boca Raton",
          "Boca Raton business IT solutions",
          "managed IT South Florida",
        ]}
        service={{
          serviceType: "Managed IT Services",
          provider: "Compuwork",
          areaServed: ["Boca Raton", "Palm Beach County", "Deerfield Beach", "Delray Beach", "Pompano Beach", "Fort Lauderdale"],
        }}
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "Locations", url: "/locations" },
          { name: "Florida", url: "/locations/managed-it-services-florida" },
          { name: "Boca Raton", url: "/locations/managed-it-services-boca-raton" },
        ]}
        faq={faqs}
      />

      <KeyFacts
        entityName="Compuwork Managed IT Services in Boca Raton"
        entityType="LocalBusiness"
        description="Managed IT and cybersecurity services tailored for small and mid-sized regulated organizations in Boca Raton. We support financial firms, law offices, healthcare practices, and growing businesses throughout Palm Beach County."
        facts={[
          { label: "Service Area", value: "Boca Raton, Delray Beach, Deerfield Beach, Pompano Beach, Palm Beach County, South Florida" },
          { label: "Industries Served", value: "Finance, Healthcare, Legal, Professional Services" },
          { label: "Compliance Expertise", value: "SEC, FINRA, HIPAA, NIST CSF, SOC 2" },
        ...
        contactInfo={{
          ...
          website: "https://compuwork.ai/locations/managed-it-services-boca-raton",
        }}
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="pt-8">
              ...
              >
                Compuwork delivers managed IT services & cybersecurity services in Boca Raton designed to help companies achieve their goals.
              </motion.p>
              ...
              >
                {[
                  "24/7/365 Support Across South Florida",
                  "SEC, FINRA & HIPAA Compliance Experts",
                  "Local Teams in Palm Beach County",
                ].map((item, index) => (
          ...
          <div className="flex flex-col lg:hidden gap-8">
            <AnimatedSection>
              <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[3/4]">
                <img src={typeof bocaRatonImage === "string" ? bocaRatonImage : (bocaRatonImage as any).src} 
                  alt="Managed IT services team supporting businesses in Boca Raton, Florida."
            ...
            <AnimatedSection delay={0.2}>
              <h2 className="text-3xl font-bold font-display text-foreground mb-4">
                Learn how Compuwork manages your IT in{" "}
                <span className="text-gradient-gold">Boca Raton</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Compuwork provides customized managed IT and cybersecurity services, specifically for regulated organizations in Boca Raton. Whether you have a financial advisory firm near Mizner Park, a healthcare practice in West Boca, or a legal office along Federal Highway, we understand the business challenges in your area.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                We are your technology partner, so that you can continue concentrating on growing your business while we ensure that your systems are secure, interconnected, and can grow with you. <strong className="text-foreground">If any of these issues are common to you, Compuwork can help you transform your IT from being a liability into a competitive advantage.</strong>
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold font-display text-foreground mb-4">
              ...
              <span className="text-gradient-gold">Boca Raton Businesses</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              As organizations across Boca Raton grow and evolve, many face recurring IT and compliance challenges.
            </p>
          </AnimatedSection>
      ...
      <Services heading="Managed IT Services in Boca Raton Built for" compactHeading />
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Boca Raton's regulated industries rely on steady operations, strong security, and clear documentation. Compuwork delivers all three.
            </p>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-display text-primary-foreground mb-4">
              Why Boca Raton Businesses Choose{" "}
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Trusted by regulated organizations across Boca Raton
            </p>
          </AnimatedSection>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <AnimatedSection>
              <div className="rounded-2xl overflow-hidden border border-border shadow-lg">
                <iframe
                  title="Compuwork Service Coverage - Boca Raton"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57248.69841537!2d-80.13745!3d26.3586!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d91f5cbf64703d%3A0x2b0ffa46e2add!2sBoca%20Raton%2C%20FL!5e0!3m2!1sen!2sus!4v1706000000000!5m2!1sen!2sus"
                  width="100%"
                  height="400"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="mt-4 flex items-center gap-2 text-muted-foreground">
                ...
                <span className="text-sm">Serving Boca Raton and Palm Beach County</span>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                From Boca Raton to New York, we provide on-site and remote IT support to businesses across the United States.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-primary-foreground/70 mb-8">
              If your Boca Raton business needs dependable IT support, cybersecurity, and cloud solutions delivered by a partner who values relationships, compliance, and long-term results, Compuwork is ready.
            </p>
...
export default BocaRatonNewPage;
