  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Managed IT services for financial services firms in West Palm Beach. Compliance-first IT, cybersecurity, and 24/7 support for SEC and FINRA-regulated organizations. Get Your Free Assessment."
