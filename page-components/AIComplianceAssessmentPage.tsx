...
import {
  aiComplianceSections,
  calculateAIComplianceScore,
  getComplianceSectionScore,
} from "@/data/aiComplianceQuestions";
...
const sectionIcons: Record<string, typeof Shield> = {
  ...
  "technical-infrastructure": Building2,
  "ai-governance-nist": Shield,
  "sec-finra-compliance": Scale,
  "organization-readiness": Users,
};

const AIComplianceAssessmentPage = () => {
  ...
  useEffect(() => {
    const hasAccess = sessionStorage.getItem("ai_compliance_access");
    if (!hasAccess) {
      navigate("/get-ai-compliance-assessment", { replace: true });
    } else {
      setIsAuthorized(true);
    }
  }, [router]);

  const totalQuestions = aiComplianceSections.reduce(
  ...
  const currentSection = aiComplianceSections[currentStep];
  const isLastSection = currentStep === aiComplianceSections.length - 1;
  const isContactStep = currentStep === aiComplianceSections.length;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = calculateAIComplianceScore(answers);
      ...
      const { error } = await supabase.functions.invoke("submit-contact", {
        body: {
          ...
          reason: "AI Integration Compliance Assessment",
          message: `AI Compliance Score: ${result.totalScore}/${result.maxScore} (${result.percentage}%) - ${result.readinessLabel}. Title: ${contactInfo.title}`,
          website: honeypot,
          formStartTime,
  ...
  if (showResults) {
    return (
      <div className="min-h-screen bg-background">
        <SEO
          title="AI Integration Compliance Assessment Results | Compuwork"
          description="View your AI integration compliance assessment results and get personalized recommendations for SEC, FINRA, and NIST alignment."
          canonical="/ai-compliance-assessment"
        />
        <Header />
            ...
            <AnimatedSection className="max-w-4xl mx-auto">
              ...
              <div className="bg-card border border-border rounded-2xl p-8 mb-8">
                ...
                <div className="space-y-6">
                  {aiComplianceSections.map((section) => {
                    const sectionResult = getComplianceSectionScore(section.id, answers);
              ...
              {/* CTA */}
              <div className="bg-gradient-to-br from-gold/10 to-violet-500/5 border border-gold/20 rounded-2xl p-8 text-center">
                <h2 className="text-2xl font-bold text-foreground mb-4">
                  Ready to Achieve Full AI Compliance?
                </h2>
                <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
                  Our compliance experts can help you address gaps and implement SEC/FINRA/NIST-aligned AI solutions tailored to your organization.
                </p>
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="AI Integration Compliance Assessment | Compuwork"
        description="Evaluate your organization's AI compliance readiness for SEC, FINRA, and NIST requirements. Get a personalized compliance score and recommendations."
        canonical="/ai-compliance-assessment"
        keywords={[
        ...
        breadcrumbs={[
          { name: "Home", url: "/" },
          { name: "AI Compliance", url: "/services/ai-compliance" },
          { name: "AI Compliance Assessment", url: "/ai-compliance-assessment" },
        ]}
      />
      <Header />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-display text-foreground mb-6 leading-tight">
              Is Your AI Integration{" "}
              <span className="text-gradient-gold">Compliance Ready?</span>
            </h1>

            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">
              Evaluate your readiness for SEC, FINRA, and NIST requirements across 7 key compliance dimensions.
            </p>
                ...
                >
                  <div className="bg-card border border-border rounded-2xl p-8">
                    <h2 className="text-2xl font-bold text-foreground mb-2">
                      Get Your Compliance Results
                    </h2>
                    <p className="text-muted-foreground mb-8">
                      Enter your details to receive your AI compliance score and personalized recommendations.
                    </p>
                  ...
                  <div className="bg-card border border-border rounded-2xl p-8">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-12 h-12 bg-gold/10 rounded-xl flex items-center justify-center">
                        {(() => {
                          const Icon = sectionIcons[currentSection.id] || Shield;
                          return <Icon className="w-6 h-6 text-gold" />;
                        })()}
                      </div>
                      <div>
                        <div className="text-sm text-muted-foreground">
                          Section {currentStep + 1} of {aiComplianceSections.length}
                        </div>
...
export default AIComplianceAssessmentPage;
