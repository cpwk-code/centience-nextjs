...
const AIComplianceGovernancePage = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="AI Compliance & Governance for Regulated Industries | Compuwork"
        ...
        canonical="/services/ai-compliance-governance"
        keywords={[
        ...
        breadcrumbs={[
          ...
          { name: 'AI Compliance & Governance', url: '/services/ai-compliance-governance' },
        ]}
        faq={[
          {
      ...
      <section className="pt-32 pb-24 mesh-gradient relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl">
            ...
            >
              AI Compliance & Governance for <span className="text-gradient-gold">Regulated Industries</span>
            </motion.h1>
...
export default AIComplianceGovernancePage;
