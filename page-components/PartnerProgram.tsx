...
import { ArrowRight, Shield, Users, Building2, Cpu, CheckCircle2, HandshakeIcon } from "lucide-react";
...
const partnerTypes = [
  ...
  { icon: HandshakeIcon, title: "Fractional CTOs and Technology Executives", description: "You define the technology direction. Centience implements the governance around it — ensuring your clients' technology decisions are compliant, documented, and audit-ready." },
];
