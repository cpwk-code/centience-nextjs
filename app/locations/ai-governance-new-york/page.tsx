...
export const metadata: Metadata = {
  ...
  description: "Continuous AI and technology governance for regulated organizations in New York City, Manhattan, and the Tri-State area. SEC, FINRA, and HIPAA compliance.",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Our clients in New York have maintained a documented track record of successful outcomes across regulatory examinations. That result comes from governance that is technically enforced — not written in a policy document filed in a drawer.
                </p>
