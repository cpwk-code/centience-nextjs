...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Governance Palm Beach County FL | Centience — Technology Governance",
    description: "Continuous AI and technology governance for regulated organizations in Palm Beach County, FL. SEC, FINRA, and HIPAA compliance. Serving West Palm Beach, Boca Raton, and Palm Beach Gardens.",
    url: "https://centience.ai/locations/ai-governance-palm-beach",
    type: 'website',
    siteName: 'Centience',
    images: [{ url: "https://centience.ai/og-image.png", width: 1200, height: 630, alt: "AI Governance Palm Beach County FL | Centience — Technology Governance" }],
  },
  twitter: {
...
const localBusinessSchema = {
  ...
  "name": "Centience \u2014 Palm Beach County",
  "url": "https://centience.ai/locations/ai-governance-palm-beach",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://centience.ai/locations/ai-governance-palm-beach"
    }
  ]
};
          ...
          <div className="container mx-auto">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-6">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Palm Beach County, FL</p>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold leading-tight mb-6">
                AI & Technology Governance for Palm Beach County Regulated Organizations
              </h1>
              <p className="text-lg opacity-80 leading-relaxed mb-8">
                Centience delivers continuous AI and technology governance programs for regulated organizations in Palm Beach County — including broker-dealers, RIAs, healthcare organizations, and law firms.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Centience builds and operates continuous AI and technology governance programs for regulated organizations in Palm Beach County. We combine managed infrastructure, cybersecurity oversight, and AI governance into a single continuously enforced model.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Our clients in Palm Beach have maintained a documented track record of successful outcomes across regulatory examinations. That result comes from governance that is technically enforced — not written in a policy document filed in a drawer.
                </p>
              ...
              <div>
                <h3 className="text-lg font-display font-bold text-primary mb-4">Industries We Serve in Palm Beach</h3>
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground"><CheckCircle2 size={14} className="text-accent shrink-0" />Non-Profit Organizations</li>
                </ul>
              ...
              <span className="text-sm text-muted-foreground">West Palm Beach</span>
              <span className="text-sm text-muted-foreground">Palm Beach Gardens</span>
              <span className="text-sm text-muted-foreground">Boca Raton</span>
              <span className="text-sm text-muted-foreground">Delray Beach</span>
              <span className="text-sm text-muted-foreground">Boynton Beach</span>
