            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Our clients in Miami have maintained a 100% audit success rate across all regulatory examinations. That result comes from governance that is technically enforced — not written in a policy document filed in a drawer.
                </p>
