...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Governance Manhattan | Centience — Technology Governance for Regulated Firms",
    description: "Continuous AI and technology governance for regulated organizations in Manhattan. SEC, FINRA, and HIPAA compliance. Serving broker-dealers, RIAs, healthcare, law firms, and private equity in Midtown and the Financial District.",
    url: "https://centience.ai/locations/ai-governance-manhattan",
    type: 'website',
    siteName: 'Centience',
    images: [{ url: "https://centience.ai/og-image.png", width: 1200, height: 630, alt: "AI Governance Manhattan | Centience — Technology Governance for Regulated Firms" }],
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Manhattan",
      "item": "https://centience.ai/locations/ai-governance-manhattan"
    }
  ]
};
          ...
          <div className="container mx-auto">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-6">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Manhattan, NY</p>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold leading-tight mb-6">
                AI & Technology Governance for Manhattan Regulated Organizations
              </h1>
              <p className="text-lg opacity-80 leading-relaxed mb-8">
                Centience delivers continuous AI and technology governance programs for Manhattan-based broker-dealers, RIAs, healthcare organizations, law firms, and private equity firms.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Centience builds and operates continuous AI and technology governance programs for regulated organizations in Manhattan. We combine managed infrastructure, cybersecurity oversight, and AI governance into a single continuously enforced model.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <div>
                <h3 className="text-lg font-display font-bold text-primary mb-4">Industries We Serve in Manhattan</h3>
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground"><CheckCircle2 size={14} className="text-accent shrink-0" />Hedge Funds</li>
                </ul>
              ...
              <span className="text-sm text-muted-foreground">Midtown Manhattan</span>
              <span className="text-sm text-muted-foreground">Financial District</span>
              <span className="text-sm text-muted-foreground">Tribeca</span>
              <span className="text-sm text-muted-foreground">SoHo</span>
              <span className="text-sm text-muted-foreground">Upper East Side</span>
              <span className="text-sm text-muted-foreground">Upper West Side</span>
                </div>
              </div>
            </div>
          </div>
