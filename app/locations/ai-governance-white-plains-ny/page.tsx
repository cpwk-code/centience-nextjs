...
export const metadata: Metadata = {
  title: "AI Governance White Plains NY | Centience — Technology Governance",
  description: "Continuous AI and technology governance for regulated organizations in White Plains NY and Westchester County. SEC, FINRA, and HIPAA compliance.",
  keywords: ["AI governance White Plains NY", "technology governance Westchester", "SEC FINRA compliance White Plains", "HIPAA compliance White Plains NY", "managed IT governance Westchester County"],
  alternates: {
    canonical: "https://centience.ai/locations/ai-governance-white-plains-ny",
  },
  openGraph: {
    title: "AI Governance White Plains NY | Centience — Technology Governance",
    description: "Continuous AI and technology governance for regulated organizations in White Plains NY and Westchester County. SEC, FINRA, and HIPAA compliance. Serving White Plains, Tarrytown, and surrounding communities.",
    url: "https://centience.ai/locations/ai-governance-white-plains-ny",
    type: 'website',
    siteName: 'Centience',
    images: [{ url: "https://centience.ai/og-image.png", width: 1200, height: 630, alt: "AI Governance White Plains NY | Centience — Technology Governance" }],
  },
  twitter: {
...
const localBusinessSchema = {
  ...
  "name": "Centience \u2014 White Plains, NY",
  "url": "https://centience.ai/locations/ai-governance-white-plains-ny",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://centience.ai/locations/ai-governance-white-plains-ny"
    }
  ]
};
          ...
          <div className="container mx-auto">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-6">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">White Plains, NY, NY</p>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold leading-tight mb-6">
                AI & Technology Governance for White Plains NY Regulated Organizations
              </h1>
              <p className="text-lg opacity-80 leading-relaxed mb-8">
                Centience delivers continuous AI and technology governance programs for regulated organizations in White Plains and Westchester County — including broker-dealers, healthcare organizations, and law firms.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Centience builds and operates continuous AI and technology governance programs for regulated organizations in White Plains, NY. We combine managed infrastructure, cybersecurity oversight, and AI governance into a single continuously enforced model.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Our clients in White Plains have maintained a documented track record of successful outcomes across regulatory examinations. That result comes from governance that is technically enforced — not written in a policy document filed in a drawer.
                </p>
              ...
              <div>
                <h3 className="text-lg font-display font-bold text-primary mb-4">Industries We Serve in White Plains</h3>
              ...
              <span className="text-sm text-muted-foreground">White Plains</span>
              <span className="text-sm text-muted-foreground">Tarrytown</span>
              <span className="text-sm text-muted-foreground">Yonkers</span>
              <span className="text-sm text-muted-foreground">New Rochelle</span>
              <span className="text-sm text-muted-foreground">Scarsdale</span>
              <span className="text-sm text-muted-foreground">Harrison</span>
              <span className="text-sm text-muted-foreground">Rye</span>
                </div>
              </div>
            </div>
          </div>
