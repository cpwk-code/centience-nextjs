...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Governance Greenwich CT | Centience — Technology Governance for Hedge Funds & RIAs",
    description: "Continuous AI and technology governance for hedge funds, family offices, and regulated organizations in Greenwich CT and Fairfield County. SEC, FINRA compliance. Serving Greenwich, Stamford, Westport, and Norwalk.",
    url: "https://centience.ai/locations/ai-governance-greenwich-ct",
    type: 'website',
    siteName: 'Centience',
    images: [{ url: "https://centience.ai/og-image.png", width: 1200, height: 630, alt: "AI Governance Greenwich CT | Centience — Technology Governance for Hedge Funds & RIAs" }],
  },
  twitter: {
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Greenwich, CT",
      "item": "https://centience.ai/locations/ai-governance-greenwich-ct"
    }
  ]
};
          ...
          <div className="container mx-auto">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-6">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Greenwich, CT, CT</p>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold leading-tight mb-6">
                AI & Technology Governance for Greenwich CT Regulated Organizations
              </h1>
              <p className="text-lg opacity-80 leading-relaxed mb-8">
                Centience delivers continuous AI and technology governance programs for hedge funds, family offices, RIAs, and regulated organizations in Greenwich and Fairfield County, CT.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Centience builds and operates continuous AI and technology governance programs for regulated organizations in Greenwich, CT. We combine managed infrastructure, cybersecurity oversight, and AI governance into a single continuously enforced model.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Our clients in Greenwich have maintained a documented track record of successful outcomes across regulatory examinations. That result comes from governance that is technically enforced — not written in a policy document filed in a drawer.
                </p>
              ...
              <div>
                <h3 className="text-lg font-display font-bold text-primary mb-4">Industries We Serve in Greenwich</h3>
                <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2 text-sm text-muted-foreground"><CheckCircle2 size={14} className="text-accent shrink-0" />Hedge Funds & Family Offices</li>
              ...
              <span className="text-sm text-muted-foreground">Greenwich</span>
              <span className="text-sm text-muted-foreground">Stamford</span>
              <span className="text-sm text-muted-foreground">Westport</span>
              <span className="text-sm text-muted-foreground">Norwalk</span>
              <span className="text-sm text-muted-foreground">Darien</span>
              <span className="text-sm text-muted-foreground">New Canaan</span>
              <span className="text-sm text-muted-foreground">Wilton</span>
              <span className="text-sm text-muted-foreground">Fairfield</span>
                </div>
              </div>
            </div>
          </div>
