...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://centience.ai/locations/ai-governance-westchester",
    type: 'website',
    siteName: 'Centience',
    images: [{ url: "https://centience.ai/og-image.png", width: 1200, height: 630, alt: "AI Governance Westchester County NY | Centience — Technology Governance" }],
  },
  twitter: {
...
const localBusinessSchema = {
  ...
  "name": "Centience \u2014 Westchester County",
  "url": "https://centience.ai/locations/ai-governance-westchester",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://centience.ai/locations/ai-governance-westchester"
    }
  ]
};
          ...
          <div className="container mx-auto">
            <div className="max-w-3xl">
              <div className="flex items-center gap-2 mb-6">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Westchester County, NY</p>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold leading-tight mb-6">
                AI & Technology Governance for Westchester County Regulated Organizations
              </h1>
              <p className="text-lg opacity-80 leading-relaxed mb-8">
                Centience delivers continuous AI and technology governance programs for regulated organizations in Westchester County — including broker-dealers, RIAs, healthcare organizations, and law firms.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Centience builds and operates continuous AI and technology governance programs for regulated organizations in Westchester County. We combine managed infrastructure, cybersecurity oversight, and AI governance into a single continuously enforced model.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  Our clients in Westchester have maintained a documented track record of successful outcomes across regulatory examinations. That result comes from governance that is technically enforced — not written in a policy document filed in a drawer.
                </p>
              ...
              <div>
                <h3 className="text-lg font-display font-bold text-primary mb-4">Industries We Serve in Westchester</h3>
              ...
              <span className="text-sm text-muted-foreground">Mount Vernon</span>
