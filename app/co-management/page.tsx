...
export const metadata: Metadata = {
  ...
  description: "Centience works alongside your existing CISO, vCISO, CTO, and outside security firms. Full management or co-management — we implement the governance layer without displacing your team.",
  keywords: ["co-managed IT","co-managed cybersecurity","CISO collaboration","vCISO partner","technology co-management","governance co-management","managed security partner","co-managed governance"],
  alternates: { canonical: "https://centience.ai/co-management" },
  openGraph: {
    title: "Co-Management & Team Collaboration | Centience",
